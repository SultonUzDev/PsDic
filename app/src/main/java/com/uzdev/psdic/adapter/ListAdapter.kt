package com.uzdev.psdic.adapter
...
import com.uzdev.psdic.fragments.list.ListFragmentDirections
    ...
    inner class MyViewHolder(
        ...
        fun bind(data: Word) {
            if (adapterPosition != RecyclerView.NO_POSITION) {
                binding.roootLayout.setOnClickListener {
        ...
        private fun showPopupMenu(data: Word, context: Context) {
            ...
            val popupMenu = PopupMenu(binding.roootLayout.context, binding.roootLayout)
            popupMenu.apply {
            ...
            val menuHelper: MenuPopupHelper = MenuPopupHelper(
                binding.roootLayout.context,
                popupMenu.menu as MenuBuilder, binding.roootLayout
            )
